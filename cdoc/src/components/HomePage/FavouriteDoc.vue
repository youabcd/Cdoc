              ...
              <el-dropdown-menu slot="dropdown"  style="width: 220px">
                <van-row><van-col span="2"></van-col>
                  <van-col span="20">
                    ...
                    <el-dropdown-item icon="el-icon-star-off" divided command="2">取消收藏</el-dropdown-item>
...
//分享框部分
      ...
      loadData(){
        ...
        axios.post(baseUrl+'/getUserFavouriteDoc',data)
          .then(function (response) {
            _this.fileList = [];
            for(let i=0; i<response.data.length; i++){
              let dlist = [];
